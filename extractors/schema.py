...
class RelationOntology:
    ...
    TRIGGER_TABLE: dict[str, list[str]] = {
        ...
        "improves": ["显著提升", "大幅提升", "进一步提升", "提升", "提高", "改善", "增强", "强化", "扩大", "增大"],
        "reduces": ["大幅降低", "显著降低", "进一步降低", "降低", "减少", "减小", "削弱", "抑制", "缓解", "防止", "阻止", "缩小", "缩减"],
        "causes": ["导致", "造成", "引起", "引发", "致使"],
        "leads_to": ["使得", "进而使", "进而"],
        ...
        "develops": ["研发", "开发", "提出了", "提出", "发展和完善", "发展", "完善", "设计了", "设计出", "设计"],
        "originates_from": ["起源于", "源于", "始于", "始建于", "诞生于"],
        "greater_than": ["远大于", "大于", "高于", "多于", "超过"],
        "less_than": ["远小于", "小于", "低于", "少于", "不超过"],
        "equals_to": ["等于", "相当于", "约等于", "近似为", "约为"],
